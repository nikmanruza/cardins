...
import { Menu, Search, ShoppingBag, Heart, UserRound, Zap, X } from "lucide-react";
...
export function SiteHeader() {
  ...
  return (
    <header
      className={cn(
        "sticky top-0 z-40 border-b transition-[height,background-color,border-color] duration-200",
        scrolled
          ? "h-14 border-border bg-background/85 backdrop-blur-md"
          : "h-16 border-transparent bg-background",
      )}
    >
      <div className="mx-auto flex h-full max-w-7xl items-center gap-4 px-4">
        ...
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="font-display text-base font-semibold tracking-tight">NexusKeys</span>
        </Link>
